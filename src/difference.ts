...
function difference<T, S extends ReadonlyArray<T>[]>(...args: [...S]): OperatorFunction<T, T>
function difference<T, S extends ReadonlyArray<T>[]>(...args: [...S, (a: T, b: T) => boolean]): OperatorFunction<T, T>
function difference<T>(...arrays: any[]) {
